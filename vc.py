...
if input("Добавить информацию info.txt? y/n: ").strip() == "y":
    upd_name = input("Введите название обновления: ")
    upd_desc = input("Опишите нововведения: ")
...
if upd_name != "" or upd_desc != "":
    with open(f"{new_dir_path}info.txt", "x", encoding="utf-8") as file:
